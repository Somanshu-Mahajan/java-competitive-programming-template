...
3. Open all the three files <code>Template.java</code>, <code>input.txt</code> and <code>output.txt</code> in the folder and keep selected <code>Template.java</code>.<br>
   <img width="2408" height="650" alt="image" src="https://github.com/user-attachments/assets/e5d87148-40a1-4911-a7b4-7e0c1186c7d8"/>

4. Right click on <code>Template.java</code> and select Split Left.<br>
...
6. Type your code in while loop of main function.<br>Example: Addtion of two numbers<br>
   <img width="2782" height="1224" alt="image" src="https://github.com/user-attachments/assets/0850d545-c613-42c3-b06e-8256d6e0b35e" />
